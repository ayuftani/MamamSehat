...
public class MenuActivity extends AppCompatActivity {
    ...
    private FloatingActionButton fb_add, fb_refresh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fb_refresh = findViewById(R.id.fb_refresh);
        ...
        fb_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MenuActivity.this, InputMenuActivity.class);
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                for (QueryDocumentSnapshot document : task.getResult()) {
                                    ...
                                    adapter = new MenuAdapter(MenuActivity.this, menuArray);
