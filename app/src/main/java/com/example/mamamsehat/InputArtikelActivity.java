...
public class InputArtikelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getJudul.equals("") || getDeskripsi.equals("")){
                    Toast.makeText(InputArtikelActivity.this, "Lengkapi Data", Toast.LENGTH_SHORT).show();
                }else{
                    uploadFirebase();
                }
    ...
    public void uploadFirebase(){
        ...
        final String getJudul = judul.getText().toString();
        final String getDeskripsi = deskripsi.getText().toString();

        StorageReference ref = mStorageRef.child(getJudul);
...
//                        MenuData menu = new MenuData(getJudul,getDeskripsi, getDownloadUrl);

                        Map<String, String> inputMenu = new HashMap<>();
                        inputMenu.put("name", getJudul);
                        ...
                        firebaseFirestore.collection("menu").add(inputMenu)
                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    ...
                                    public void onSuccess(DocumentReference documentReference) {
                                        Toast.makeText(InputArtikelActivity.this, "Berhasil mengunggah", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(InputArtikelActivity.this, MenuActivity.class);
                                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                        InputArtikelActivity.this.startActivity(intent);
                                    }
                                });
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        Toast.makeText(InputArtikelActivity.this, "Gagal mengunggah.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    protected void onActivityResult(int reqCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            try {
                ...
                e.printStackTrace();
                Toast.makeText(InputArtikelActivity.this, "Gagal.", Toast.LENGTH_LONG).show();
            }

        }else {
            Toast.makeText(InputArtikelActivity.this, "Jangan Lupa Pilih Gambar.",Toast.LENGTH_LONG).show();
        }
    }
